    ...
    >
      ...
      <div class="relative z-10 mx-auto mt-6 w-full max-w-4xl rounded-3xl border border-white/10 bg-slate-950/95 p-5 shadow-[0_30px_100px_-40px_rgba(15,23,42,0.95)]">
        <div class="flex items-center justify-between gap-3">
          <div class="min-w-0">
            <p class="text-[10px] font-semibold tracking-[0.24em] text-cyan-200/80 uppercase">Preview</p>
            <div class="mt-1 flex items-center gap-3">
              <h4 class="truncate text-lg font-semibold text-slate-50">{text.editor.preview}</h4>
              <span class="badge badge-live">{text.preview.live}</span>
            </div>
          </div>
